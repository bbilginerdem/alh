...
const Contact = () => {
  return (
    <section className="relative my-32 min-h-120 w-full px-4 sm:px-8 lg:my-40">
      <div className="-z-20 relative mx-auto max-w-7xl rounded-2xl py-24 text-blue-50 sm:overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center px-6 text-center sm:px-8">
          <div className="mb-12 flex flex-col items-center">
            <p className="font-general text-orange-300 text-xs uppercase tracking-[0.3em]">
              Bize Ulaşın
            </p>
