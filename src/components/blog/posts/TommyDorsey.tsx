			...
			<div className="max-w-none">
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-base md:text-lg">
						...
						bebop gibi yeni caz akımlarından etkilenerek müziğini
						modernleştirdi. Ne var ki, swing döneminin altın çağının tekrarı
						mümkün olmadı.
					</p>
					<p className="text-base md:text-lg">
						Tommy Dorsey,{" "}
				...
				<section className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
					...
					<p className="mb-4 text-base md:text-lg">
						...
						de önemli bir rol oynamıştır. Dans pistlerinde fırtına estiren
						tempolu parçaları, dansçıların ilham kaynağı olmuş ve swing
						döneminin ruhunu yansıtmıştır.
					</p>
					<p className="text-base md:text-lg">
