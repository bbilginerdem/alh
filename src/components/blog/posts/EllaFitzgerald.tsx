			...
			<div className="max-w-none">
				<section className="mb-8">
					<p className="mb-6 text-base md:text-lg">
						...
						Ella'nın çocukluğu, yoksulluk ve ailevi sorunlarla dolu, hiç de
						kolay geçmemişti.
					</p>
					...
					<div className="mb-8 flex flex-col gap-6 md:flex-row">
						...
						<div className="md:w-1/2">
							<p className="mb-4 text-base md:text-lg">
								...
								sonra ayrılmış, o da annesi ve üvey babasıyla New York'un
								Yonkers şehrine taşınmıştı. Daha on beş yaşındayken, annesinin
								bir trafik kazasında aldığı yaralardan hayatını kaybetmesiyle
								yaşamı altüst oldu. Bu kaybın yarattığı sarsıntıyla Ella'nın
								yaşamı kontrolden çıktı ve sonunda kaçarak,{" "}
								<span className="font-semibold">
									Büyük Buhran'ın zor günlerinde Harlem'in sokaklarında
									yapayalnız kaldı
								</span>
								.
							</p>
					...
					<p className="text-base md:text-lg">
						Hayatta kalmak için, genç Ella'nın sahip olduğu tek şeye, yani
						sesine sığındı. Sokak başlarında şarkı söyleyerek geçimini sağladı.
						Aslında hayali bir dansçı olmaktı, ancak{" "}
						<span className="font-semibold">
				...
				<section className="mb-8 rounded-lg bg-white/10 p-6 backdrop-blur-sm">
					...
					<p className="mb-4 text-base md:text-lg">
						...
						amansız bir kararlılık taşıyan Ella, Amatör Gecesi için sahneye
						çıktı. Aslında dans etmeyi planlıyordu ama sahne korkusu yüzünden
						şarkı söylemeye karar verdi.
					</p>
					<p className="text-base md:text-lg">
						Annesinin çok sevdiği{" "}
						<span className="font-semibold">"The Object of My Affection"</span>{" "}
						adlı şarkıyı seslendirdi ve ilk notadan itibaren sihirli bir şey
						oldu. Saf, berrak, sıcak ve çevik bir soprano olan sesi salonu
						doldurdu. Sadece notaları söylemiyor, onları hissediyor gibiydi.
						Yarışmayı ve 25 dolarlık ödülü kazanmakla kalmadı, geleceğini de
						kazanmıştı. O kader gecesinde salonda, ünlü davulcu ve orkestra şefi{" "}
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-base md:text-lg">
						<span className="font-semibold">Chick Webb</span>, başlangıçta
						Ella'yı isteğe isteksiz alsada, orkestradaki müzisyenlerin ısrarı
						üzerine hamisi, akıl hocası ve kariyerinin ilk büyük iş ortağı oldu.
						Onun vejetasyonu sayesinde, sokaklardan gelen Ella Fitzgerald,
						yıldız Ella Fitzgerald'a dönüştü.
					</p>
					<p className="mb-4 text-base md:text-lg">
						Onların iş birliği, caz tarihinin en ikonik anlarından birini
						yarattı. 1938'de, tekerleme havasındaki neşeli bir şarkıyı,{" "}
				...
				<section className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
					...
					<p className="mb-4 text-base md:text-lg">
						...
						şeflerinden biri yaptı. Grubu birkaç yıl boyunca zarafetle
						yönettikten sonra solo kariyerine adım attı.
					</p>
					<p className="text-base md:text-lg">
						Bu dönem, onu sadece bir "şarkıcı" değil, tam teşekküllü bir
						müzisyen olarak sağlamlaştırdı. Artık bir virtüözdü; korkunç bir
						enerjiyle sallanabilen veya balad inceliğiyle süzülebilen karmaşık
						doğaçlamalar örebiliyordu.
					</p>
				</section>
				...
				<section className="my-8">
					...
					<p className="mb-4 text-base md:text-lg">
						...
						özümsemeye başladı. İşte burada, onun en göz kamaştırıcı silahı
						olacak şeyi, <span className="font-semibold">"scat"</span> şarkı
						söylemeyi mükemmelleştirdi.
					</p>
					<p className="text-base md:text-lg">
						Diğerleri bunda sınırlı denemeler yapmış olsa da, Ella, scat'i
						yüksek bir sanat formuna dönüştürdü. Sesini artık yalnızca bir
						melodi enstrümanı olarak değil, tam teşekküllü bir "nefesli çalgı"
						...
						<span className="font-semibold">"Flying Home"</span> parçası, hala
						bir dönüm noktası sayılan, müzisyenleri ve dinleyicileri hayrete
						düşüren, ritmik hassasiyet ve melodik yaratıcılığın nefes kesici bir
						sergisi olan bir scat solosu içeriyordu.
					</p>
				</section>
