	...
	return (
		<article>
				...
				<div className="mb-8 flex flex-col gap-6 md:flex-row">
					...
					<div className="md:w-1/2">
						...
						<p className="mb-4">
							...
							1920'lerin sonunda Harlem, New York'ta doğan ve swing müziğiyle
							bütünleşen bir sokak dansıdır. Kökleri Charleston, Tap ve
							Afro-Amerikan dans geleneklerine dayanan Lindy Hop, özgürlüğün,
							yaratıcılığın ve sosyal etkileşimin dansı olarak bilinir.
						</p>
						<p className="mb-4">
							Lindy Hop, ismini 1927'de Charles Lindbergh'in ("Lucky Lindy")
							Atlantik Okyanusu'nu tek başına uçarak geçmesinden sonra
							gazetelerde çıkan "Lindy Hops the Atlantic" başlığından almıştır.
						</p>
						<p className="mb-4">
							Özgürlüğün, yaratıcılığın ve sosyal etkileşimin dansı olarak
							bilinen Lindy Hop, temelde 8 veya 6 zamanlı bir dans olup,
							"swing-out" adı verilen açık pozisyon ve "closed position" olarak
							adlandırılan kapalı pozisyon temel hareketlerinden oluşur. Ancak
							gerçek güzelliği, dansçıların bu temeller üzerine kendi
							yorumlarını ve doğaçlamalarını ekleyebilmesinde yatar.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="mb-8">
				...
				<p className="mb-6">
					1980'lerde ise <span className="font-semibold">"Swing Revival"</span>
				...
				<div className="flex flex-col gap-6 md:flex-row">
					<div className="md:w-1/2">
						<p className="mb-4">
							...
							<span className="font-semibold">ILHC</span> (Uluslararası Lindy
							Hop Şampiyonası) gibi etkinliklerle dansçılar bir araya geliyor.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="mb-8 rounded-lg bg-white/10 p-6 backdrop-blur-sm">
				...
				<p>
					...
					topluluklar, düzenli workshop'lar ve sosyal dans geceleri düzenleyerek
					bu kültürü yaymaya başladı.
				</p>
			</section>
